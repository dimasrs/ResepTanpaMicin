...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new PolaItem(R.drawable.gambar5,"Gongso Ayam","Gongso Ayam dengan bumbu pedas tanpa micin","\n" +
                "250 gram Dada Ayam\n" +
                "1 buah Tomat\n" +
                "1 sendok makan Saus Tiram\n" +
        ...
        items.add(new PolaItem(R.drawable.gambar6,"Gongso Babat","Gongso Babat dengan bumbu pedas tanpa micin","\n" +
                "1/2 kg babat\n" +
                "2 lembar daun salam\n" +
